...
public class DbAdapter {
	...
	private static final String TABLE_CREATE = "CREATE TABLE programm (_id integer primary key autoincrement,"
	...
	public long createEntry(Date datum, String thema, String person) {
		...
		return mDb.insertWithOnConflict(DATABASE_TABLE, null, initialValues,
	...
	public Cursor fetchAllEntries(String query) {
		...
		return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_DATUM,
				KEY_THEMA, KEY_PERSON }, query, null, null, null, KEY_DATUM
				+ " desc");
	}
	...
	public Cursor fetchEntry(long rowId) throws SQLException {
		Cursor mCursor = mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID,
				KEY_DATUM, KEY_THEMA, KEY_PERSON }, KEY_ROWID + "=" + rowId, null,
				null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
